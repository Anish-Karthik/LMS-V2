...
import { User, Purchase, Batch } from '@prisma/client';
...
interface UsersListProps {
  ...
  switchBatch: (prevbatchId: string, newbatchId: string, swappedPurchaseId: string) => void;
}
...
const UsersList = ({
  ...
  const [purchasesDefault, setPurchasesDefault] = useState(defaultBatch.purchases);
  const [purchasesCurrent, setPurchasesCurrent] = useState(currentBatch.purchases);
  ...
  const switchItem = (source: Purchase[], destination: Purchase[], result: DropResult) => {
      ...
      <div className='grid grid-cols-2 gap-x-2'>
        <Droppable droppableId="default">
          {(provided) => (
            ...
            <div {...provided.droppableProps} ref={provided.innerRef} className='border-2 border-secondary'>
                  ...
                  {(provided) => (
                    ...
                    >
                      <div className="flex items-center gap-x-2">
                        ...
                        <div>
                          <h3 className="text-sm font-semibold">{purchase.user.name}</h3>
