  ...
  return (
    <div>
      {userProgressTopic?.isCompleted && (
        <Banner variant="success" label="You already completed this article." />
      )}
      {isLocked && (
        <Banner
          variant="warning"
          label="You need to purchase this course to access this content."
        />
      )}
      <div className="mx-auto flex max-w-4xl flex-col pb-20">
        ...
        <div className="p-4">
          {topic.content ? (
            ...
            <Banner
              variant="warning"
              label="No article content available for this topic."
            />
          )}
        </div>
