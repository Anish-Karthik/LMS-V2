...
export default function EmploymentForm({
  ...
  const [selectedData, setSelectedData] = useState<{name: string} | null>({name: data.employmentStatus === ""? "Please Select...": data.employmentStatus });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    {!enterDelay && <div className="relative ">
                      ...
                      <Select
                        ...
                        className="bg-transparent form_select"
                        options={jobRolesObj}
