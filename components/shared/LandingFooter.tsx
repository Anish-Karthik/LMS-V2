        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-slate-300 mb-4">
              Your complete solution for organizational learning and training.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-slate-300 hover:text-white transition-colors">Case Studies</Link></li>
              <li><Link href="#" className="text-slate-300 hover:text-white transition-colors">Reviews</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-slate-300 hover:text-white transition-colors">Careers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/policies" className="text-slate-300 hover:text-white transition-colors">Privacy & Terms</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6">
              <li><Link href="/policies" className="text-slate-400 hover:text-white text-sm transition-colors">Privacy Policy</Link></li>
              <li><Link href="/policies" className="text-slate-400 hover:text-white text-sm transition-colors">Terms of Service</Link></li>
              <li><Link href="/policies" className="text-slate-400 hover:text-white text-sm transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
      </div>
